...
## 2026-04-14 - [Synchronous Form Loading State]
**Learning:** Even synchronous forms that trigger page navigations benefit from immediate visual loading feedback (like disabling the button and showing 'DECRYPTING...') to prevent duplicate submissions and improve perceived performance.
**Action:** Apply loading states and disable submit buttons immediately upon form submission, even if the form isn't using AJAX/fetch.
