...
## 2026-04-21 - [Synchronous Form Feedback]
**Learning:** Synchronous form submissions often lack immediate visual feedback, leading to potential duplicate submissions and poor perceived performance. Adding an immediate loading state before the synchronous post improves UX.
**Action:** Always provide immediate visual feedback (disabling button, changing text) even for synchronous form submissions.
