...
## 2026-03-21 - Login loading state
**Learning:** UX Pattern: Always provide immediate visual feedback (like disabling the button and changing text) even for synchronous form submissions to prevent duplicate clicks and improve perceived performance.
**Action:** Added disabled loading state and [DECRYPTING...] text change to the synchronous login form button.
