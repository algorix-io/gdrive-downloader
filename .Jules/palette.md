...
## 2026-03-01 - [Synchronous Form Loading States]
**Learning:** Users often click submit buttons multiple times if a synchronous form submission takes noticeable time to process, especially on slow network conditions or complex backend auth routines.
